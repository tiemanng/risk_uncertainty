...
# load (recoded) data ;
rm(list=ls())
exp_i   <- read.csv("../_SOURCE/REC_RESP_NOL.csv", header=TRUE)
exp_ij  <- read.csv("../_SOURCE/REC_EXP_NOL_ij.csv", header=TRUE)
exp_ij_ <- read.csv("../_SOURCE/REC_EXP_ij.csv", header=TRUE)

# within-perspective ;
exp_risk<- read.csv("../_SOURCE/REC_EXP_RISK_ij.csv", header=TRUE)
exp_ra  <- read.csv("../_SOURCE/REC_EXP_RA_ij.csv", header=TRUE)
